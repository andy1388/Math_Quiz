...
class F2L2_5_Generator_Q3_N_MQ extends QuestionGenerator_1.QuestionGenerator {
    ...
    formatExpression(p, q, factors) {
        ...
        // 计算展开式的系数
        const x2Coeff = (p * a * c) / q;
        const xCoeff = (p * (a * d + b * c)) / q;
        const constTerm = (p * b * d) / q;
...
exports.default = F2L2_5_Generator_Q3_N_MQ;
