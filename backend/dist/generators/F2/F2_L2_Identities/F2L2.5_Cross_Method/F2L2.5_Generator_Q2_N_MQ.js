...
class F2L2_5_Generator_Q2_N_MQ extends QuestionGenerator_1.QuestionGenerator {
    constructor(difficulty = 1) {
        super(difficulty, 'F2L2.5');
        this.VARIABLES = ['x', 'y', 'z', 'a', 'b', 'p', 'q', 'r', 's', 't'];
    }
    generate() {
        // 生成两个因子
    ...
    formatExpression(b, c, var1 = 'x', var2 = 'y') {
        const bTerm = b === 0 ? '' :
            b === 1 ? `+ ${var1}${var2}` :
                b === -1 ? `- ${var1}${var2}` :
    ...
    generateWrongAnswers(factors) {
        ...
        if (this.difficulty === 5) {
            ...
            // 过滤掉等价的答案
            const validWrongs = wrongChoices.filter(wrong => !this.areFactorsEquivalent(factors, wrong));
            // 添加有效的错误答案
...
exports.default = F2L2_5_Generator_Q2_N_MQ;
