...
class F1L12_1_Generator_Q1_F_MQ extends QuestionGenerator_1.QuestionGenerator {
...
${Array.from(result.variables.entries())
            ...
            .join('\n')}
3. 最終答案：\\(${result.coefficient}${sortedVars.map(([v, e]) => v + '^{' + e + '}').join('')}\\)`;
        return [questionParts.join(' × '), answer, steps];
    }
}
exports.default = F1L12_1_Generator_Q1_F_MQ;
