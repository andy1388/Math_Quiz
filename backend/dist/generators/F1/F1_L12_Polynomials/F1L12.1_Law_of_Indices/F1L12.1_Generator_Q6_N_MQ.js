...
class F1L12_1_Generator_Q6_N_MQ extends QuestionGenerator_1.QuestionGenerator {
...
3. 最終答案：\\[${answer}\\]`;
    ...
    createQuestionWithBlank(answer, terms) {
        // 收集所有可能的指数位置
        const allExponents = [];
    ...
    extractBlankPart(option, answer) {
        // 只提取指数部分的数字
        const expMatch = option.match(/\^{(\d+)}/);
        return expMatch ? expMatch[1] : option;
    }
}
exports.default = F1L12_1_Generator_Q6_N_MQ;
